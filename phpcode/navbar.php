      ...
      <nav>
        <ul>
          ...
          <li><a href="contacts.php" class="<?= ($currentPage == 'contacts.php') ? 'active' : '' ?>">Contacts</a></li>
            <div class="imglinks">
              <a class="facebook" href="www.google.com"><img src="images/facebook.png" alt="Facebook Logo"></a>
              <a href="www.learncoach.com"><img src="images/instagram.png" alt="Instagram Logo"></a>
            </div>
        </ul>
      </nav>
