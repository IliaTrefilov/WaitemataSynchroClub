    ...
    <nav>
      <ul>
        ...
        <li><a href="contacts.php" class="<?= ($currentPage == 'contacts.php') ? 'active' : '' ?>">Contacts</a></li>
          <div class="imglinks">
            <a class="facebook" href="https://www.facebook.com/waitematasynchroclub/"><img src="images/facebook.png" alt="Facebook Logo"></a>
            <a href="https://www.instagram.com/waitematasynchroclub/"><img src="images/instagram.png" alt="Instagram Logo"></a>
          </div>
      </ul>
    </nav>
    <a href="index.php"><img class="logo" src="images/logo.png" alt="Club Logo"></a>
  </div>
</header>